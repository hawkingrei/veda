...
type Saturn struct {
	...
	Metrics struct {
		...
		Gauges  struct {
			...
			Dw1MasterMysqlInfraDuitangNet3306PoolActive struct {
				Value int `json:"value"`
			} `json:"dw1.master.mysql.infra.duitang.net:3306.pool.active"`
			Dw1MasterMysqlInfraDuitangNet3306PoolIdle struct {
				Value int `json:"value"`
			} `json:"dw1.master.mysql.infra.duitang.net:3306.pool.idle"`
			Dw1Slave1MysqlInfraDuitangNet3306PoolActive struct {
				Value int `json:"value"`
			} `json:"dw1.slave-1.mysql.infra.duitang.net:3306.pool.active"`
			Dw1Slave1MysqlInfraDuitangNet3306PoolIdle struct {
				Value int `json:"value"`
			} `json:"dw1.slave-1.mysql.infra.duitang.net:3306.pool.idle"`
			StdMasterMysqlInfraDuitangNet3306PoolActive struct {
				Value int `json:"value"`
			} `json:"std.master.mysql.infra.duitang.net:3306.pool.active"`
			StdMasterMysqlInfraDuitangNet3306PoolIdle struct {
				Value int `json:"value"`
			} `json:"std.master.mysql.infra.duitang.net:3306.pool.idle"`
			StdSlave1MysqlInfraDuitangNet3306PoolActive struct {
				Value int `json:"value"`
			} `json:"std.slave-1.mysql.infra.duitang.net:3306.pool.active"`
			StdSlave1MysqlInfraDuitangNet3306PoolIdle struct {
				Value int `json:"value"`
			} `json:"std.slave-1.mysql.infra.duitang.net:3306.pool.idle"`
			StdSlave2MysqlInfraDuitangNet3306PoolActive struct {
				Value int `json:"value"`
			} `json:"std.slave-2.mysql.infra.duitang.net:3306.pool.active"`
			StdSlave2MysqlInfraDuitangNet3306PoolIdle struct {
				Value int `json:"value"`
			} `json:"std.slave-2.mysql.infra.duitang.net:3306.pool.idle"`
			StdSlave3MysqlInfraDuitangNet3306PoolActive struct {
				Value int `json:"value"`
			} `json:"std.slave-3.mysql.infra.duitang.net:3306.pool.active"`
			StdSlave3MysqlInfraDuitangNet3306PoolIdle struct {
				Value int `json:"value"`
			} `json:"std.slave-3.mysql.infra.duitang.net:3306.pool.idle"`
			StdSlave4MysqlInfraDuitangNet3306PoolActive struct {
				Value int `json:"value"`
			} `json:"std.slave-4.mysql.infra.duitang.net:3306.pool.active"`
			StdSlave4MysqlInfraDuitangNet3306PoolIdle struct {
				Value int `json:"value"`
			} `json:"std.slave-4.mysql.infra.duitang.net:3306.pool.idle"`
		} `json:"gauges"`
		Counters struct {
			SaturnBlogQueryThreadPoolRunning struct {
				Count int `json:"count"`
			} `json:"saturn.blogQueryThreadPool.running"`
		} `json:"counters"`
		Histograms struct {
		} `json:"histograms"`
		Meters struct {
			SaturnBlogQueryThreadPoolCompleted struct {
				Count    int     `json:"count"`
			...
			} `json:"saturn.blogQueryThreadPool.completed"`
			SaturnBlogQueryThreadPoolSubmitted struct {
				Count    int     `json:"count"`
				M15Rate  float64 `json:"m15_rate"`
				M1Rate   float64 `json:"m1_rate"`
				M5Rate   float64 `json:"m5_rate"`
				MeanRate float64 `json:"mean_rate"`
				Units    string  `json:"units"`
			} `json:"saturn.blogQueryThreadPool.submitted"`
		} `json:"meters"`
		Timers struct {
			SaturnBlogQueryThreadPoolDuration struct {
				Count         int     `json:"count"`
			...
			} `json:"saturn.blogQueryThreadPool.duration"`
		} `json:"timers"`
	} `json:"metrics"`
}

func (s *Saturn) toCollectData(dataChan *chan *CollectData) {
	...
	data.Data["BlogQueryThreadPoolCompletedMeanRate"] = s.Metrics.Meters.SaturnBlogQueryThreadPoolCompleted.MeanRate
	...
	data.Data["Dw1MasterMysqlInfraDuitangNet3306PoolActive"] = float64(s.Metrics.Gauges.Dw1MasterMysqlInfraDuitangNet3306PoolActive.Value)
	data.Data["Dw1MasterMysqlInfraDuitangNet3306PoolIdle"] = float64(s.Metrics.Gauges.Dw1MasterMysqlInfraDuitangNet3306PoolIdle.Value)
	data.Data["Dw1Slave1MysqlInfraDuitangNet3306PoolActive"] = float64(s.Metrics.Gauges.Dw1Slave1MysqlInfraDuitangNet3306PoolActive.Value)
	data.Data["Dw1Slave1MysqlInfraDuitangNet3306PoolIdle"] = float64(s.Metrics.Gauges.Dw1Slave1MysqlInfraDuitangNet3306PoolIdle.Value)
	data.Data["StdMasterMysqlInfraDuitangNet3306PoolActive"] = float64(s.Metrics.Gauges.StdMasterMysqlInfraDuitangNet3306PoolActive.Value)
	data.Data["StdMasterMysqlInfraDuitangNet3306PoolIdle"] = float64(s.Metrics.Gauges.StdMasterMysqlInfraDuitangNet3306PoolIdle.Value)
	data.Data["StdSlave1MysqlInfraDuitangNet3306PoolActive"] = float64(s.Metrics.Gauges.StdSlave1MysqlInfraDuitangNet3306PoolActive.Value)
	data.Data["StdSlave1MysqlInfraDuitangNet3306PoolIdle"] = float64(s.Metrics.Gauges.StdSlave1MysqlInfraDuitangNet3306PoolIdle.Value)
	data.Data["StdSlave2MysqlInfraDuitangNet3306PoolActive"] = float64(s.Metrics.Gauges.StdSlave2MysqlInfraDuitangNet3306PoolActive.Value)
	data.Data["StdSlave2MysqlInfraDuitangNet3306PoolIdle"] = float64(s.Metrics.Gauges.StdSlave2MysqlInfraDuitangNet3306PoolIdle.Value)
	data.Data["StdSlave3MysqlInfraDuitangNet3306PoolActive"] = float64(s.Metrics.Gauges.StdSlave3MysqlInfraDuitangNet3306PoolActive.Value)
	data.Data["StdSlave3MysqlInfraDuitangNet3306PoolIdle"] = float64(s.Metrics.Gauges.StdSlave3MysqlInfraDuitangNet3306PoolIdle.Value)
	data.Data["StdSlave4MysqlInfraDuitangNet3306PoolActive"] = float64(s.Metrics.Gauges.StdSlave4MysqlInfraDuitangNet3306PoolActive.Value)
	data.Data["StdSlave4MysqlInfraDuitangNet3306PoolIdle"] = float64(s.Metrics.Gauges.StdSlave4MysqlInfraDuitangNet3306PoolIdle.Value)

	data.Data["SaturnBlogQueryThreadPoolRunningCount"] = float64(s.Metrics.Counters.SaturnBlogQueryThreadPoolRunning.Count)
	data.Data["SaturnBlogQueryThreadPoolCompletedCount"] = float64(s.Metrics.Meters.SaturnBlogQueryThreadPoolCompleted.Count)
	data.Data["SaturnBlogQueryThreadPoolSubmittedCount"] = float64(s.Metrics.Meters.SaturnBlogQueryThreadPoolSubmitted.Count)
	data.Data["SaturnBlogQueryThreadPoolDurationCount"] = float64(s.Metrics.Timers.SaturnBlogQueryThreadPoolDuration.Count)
	data.Data["SaturnBlogQueryThreadPoolDurationP99"] = float64(s.Metrics.Timers.SaturnBlogQueryThreadPoolDuration.P99)
	*dataChan <- &data
}
